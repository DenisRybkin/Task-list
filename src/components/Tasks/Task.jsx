...
export const Task = ({id, text, listId , onEdit, onRemove, onCompleteTask, completed}) => {
    ...
    return (
        <div key={id} className="task__items-row">
           ...
           <p>{text}</p>
            <div className="tasks__items-row-actions">
                <div onClick={() => onEdit({id, text} ,listId)}>
                    <svg
                        width="15"
                        height="15"
                        viewBox="0 0 15 15"
                ...
                <div onClick={() => onRemove(id ,listId)}>
                    <svg
                        width="11"
                        height="11"
                        viewBox="0 0 11 11"
